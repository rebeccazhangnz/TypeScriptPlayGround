...
//in the above onlyOneClass, we can override the name property becaouse it is pbulic. (remember defining a property in constructor arg means that it defines and assign the proberty to the class itself)
console.log(onlyOneInstance.name)
onlyOneInstance.name = 'new name'
console.log(onlyOneInstance.name)

//To make this not resignable we can assign readonly keyword to the 